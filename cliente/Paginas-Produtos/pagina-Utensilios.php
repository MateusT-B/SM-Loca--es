  ...
  <div class = "row">
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 hidden-xs">
      ...
      <div class="block-content">
        ...
        <li><img src="../../icons/icone_copos-e-tacas.png" class="icone"><a href="../../cliente/produtos.php">Copos e Taças</a></li>
...
$lista = $conn->query("select * from vw_produtos where rotulo ='utensilios cozinha'");
