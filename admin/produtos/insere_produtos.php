...
if($_POST)
{
    ...
    $insereProduto = "insert produtos 
                    (id_categoria, nome_produto, imagem, valor, unidade_venda, descricao, destaque)
                    values
                    ($categoria_id,'$nome_produto', '$imagem', $valor, $unidade_venda, '$descricao', '$destaque') 
                    ";
    $resultado = $conn->query($insereProduto);            
    if(mysqli_insert_id($conn)){
        header('lista_produtos.php');
    }
}
                    ...
                    id="form_insere">
                        ...
                        <span class="input-group-addon">
                            ...
                            <label for="destaque_n" class="radio-inline">
                                <input type="radio" name="destaque" id="destaque" value="Nao" checked>Não
                            </label>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="unidade_venda" name="unidade_venda" aria-label="Quantidade de unidade de venda" placeholder="0" min="1" step="1" required>
                        </div>
