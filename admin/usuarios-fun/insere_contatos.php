...
if ($_POST) {
    ...
    if (isset($idTelefone)) {
        $stmtFuncionarioContatoTelefone = $conn->prepare("INSERT INTO funcionarios_telefones (id_funcionario, id_telefone) VALUES (?, ?)");
        $stmtFuncionarioContatoTelefone->bind_param('ii', $idFuncionario, $idTelefone);
        $resultadoFuncionarioContatoTelefone = $stmtFuncionarioContatoTelefone->execute();
        if (!$resultadoFuncionarioContatoTelefone) {
    ...
    if (isset($idEmail)) {
        $stmtFuncionarioContatoEmail = $conn->prepare("INSERT INTO funcionarios_emails (id_funcionario, id_email) VALUES (?, ?)");
        $stmtFuncionarioContatoEmail->bind_param('ii', $idFuncionario, $idEmail);
        $resultadoFuncionarioContatoEmail = $stmtFuncionarioContatoEmail->execute();
        if (!$resultadoFuncionarioContatoEmail) {
    ...
    header('Location: insere_user.php?id_funcionario=' . $idFuncionario);
    exit;
}
?>
