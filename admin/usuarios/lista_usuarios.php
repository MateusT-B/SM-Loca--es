...
$lista = $conn -> query("select * from usuarios_web");
...
<body class="corpo_lista"> 
    ...
    <main class="container-lista">
        <h2 class="breadcrumb-lista alert alert-warning">Lista de Produtos</h2>
                ...
                <?php do { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a
                                href="update_produtos.php?id=<?php echo $row['id'] ?>" 
                                role="button" 
