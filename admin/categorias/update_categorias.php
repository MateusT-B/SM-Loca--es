...
$lista = $conn->query('select * from categorias where id =' .$id_form);
                ...
                <div class="alert alert-primary" role="alert">
                    ...
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                           ...
                           <input type="text" name="sigla" id="sigla" 
                                ...
                                maxlength   ="3" value="<?php echo $row['sigla'];?>"
                            >
                        </div>   
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" name="rotulo" id="rotulo" 
                                ...
                                maxlength="30" value="<?php echo $row['rotulo'];?>">
                        </div>  
                        <br>
                        <input type="submit" name="enviar" id="enviar" class="btn btn-primary btn-block" value="Atualizar">
                    </form>
                </div>
            </div>
        </div>
